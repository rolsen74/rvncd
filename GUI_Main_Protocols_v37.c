...
static Object *Page_Protocols_v37( struct Config *cfg UNUSED )
{
Object *o;
...
//			LAYOUT_Label,				"Server Support",
			...
			LAYOUT_AddChild,			GUIObjects[ GID_Protocol_37_Enable ] = IIntuition->NewObject( CheckBoxClass, NULL,
...
static void GUIFunc_Protocol_37_Enable( struct Config *cfg )
{
uint32 val;
	
	val = 0;

	IIntuition->GetAttrs( GUIObjects[ GID_Protocol_37_Enable ],
		GA_Selected, & val,
		TAG_END
	);
...
static void Page_Refresh_Protocol_37( struct Config *cfg )
{
