...
Object *Page_Action_Server( struct Config *cfg UNUSED )
{
Object *o;
	...
	o = NewObject( LayoutClass, NULL,
		...
		LAYOUT_AddChild,					NewObject( LayoutClass, NULL,
			...
			LAYOUT_AddChild,				NewObject( LayoutClass, NULL,
				...
				LAYOUT_AddChild,			GUIObjects[ GID_Actions_Server_Start_Enable ] = NewObject( CheckBoxClass, NULL,
					GA_ID,					GID_Actions_Server_Start_Enable,
					GA_Selected,			( cfg->cfg_ActionsServerStartEnable ) ? 1 : 0,
					GA_RelVerify,			TRUE,
				End,
				CHILD_WeightedWidth,		0,
				LAYOUT_AddChild,			GUIObjects[ GID_Actions_Server_Start_Type ] = NewObject( ChooserClass, NULL,
...
//					GA_Selected,			( DoVerbose ) ? 1 : 0,
			...
			LAYOUT_AddChild,				NewObject( LayoutClass, NULL,
				LAYOUT_AddChild,			GUIObjects[ GID_Actions_Server_Start_String ] = NewObject( StringClass, NULL,
					GA_Disabled,			cfg->cfg_ActionsServerStartEnable == 0,
		...
		LAYOUT_AddChild,					NewObject( LayoutClass, NULL,
			...
			LAYOUT_AddChild,				NewObject( LayoutClass, NULL,
				LAYOUT_Orientation,			LAYOUT_ORIENT_HORIZ,
				LAYOUT_AddChild,			GUIObjects[ GID_Actions_Server_Stop_Enable ] = NewObject( CheckBoxClass, NULL,
					GA_ID,					GID_Actions_Server_Stop_Enable,
					GA_Selected,			( cfg->cfg_ActionsServerStopEnable ) ? 1 : 0,
					GA_RelVerify,			TRUE,
				End,
				CHILD_WeightedWidth,		0,
				LAYOUT_AddChild,			GUIObjects[ GID_Actions_Server_Stop_Type ] = NewObject( ChooserClass, NULL,
...
//					GA_Selected,			( DoVerbose ) ? 1 : 0,
			...
			LAYOUT_AddChild,				NewObject( LayoutClass, NULL,
				LAYOUT_AddChild,			GUIObjects[ GID_Actions_Server_Stop_String ] = NewObject( StringClass, NULL,
					GA_Disabled,			cfg->cfg_ActionsServerStopEnable == 0,
...
U32 val;
	...
	GetAttrs( GUIObjects[ GID_Actions_Server_Start_Enable ],
		GA_Selected, & val,
		TAG_END
	);
...
U32 val;
	...
	GetAttrs( GUIObjects[ GID_Actions_Server_Stop_Enable ],
		GA_Selected, & val,
		TAG_END
	);
...
void GUIFunc_UpdateActionServerStart( struct Config *cfg UNUSED )
{
STR str;

	str = NULL;

	GetAttrs( GUIObjects[ GID_Actions_Server_Start_String ],
		STRINGA_TextVal, & str,
		TAG_END
	);
...
void GUIFunc_UpdateActionServerStop( struct Config *cfg UNUSED )
{
STR str;

	str = NULL;

	GetAttrs( GUIObjects[ GID_Actions_Server_Stop_String ],
		STRINGA_TextVal, & str,
		TAG_END
	);
